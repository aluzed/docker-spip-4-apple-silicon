...
function BOUCLE_enlignehtml_eb85dd9285a02f51816fd241fc77ae31(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$command['where'] = 
			array(
			array('NOT', 
			array('=', 'auteurs.id_auteur', sql_quote(retablir_echappements_modeles(interdire_scripts(invalideur_session($Cache, table_valeur($GLOBALS["visiteur_session"]??[], (string)'id_auteur', null)))), '', 'bigint NOT NULL AUTO_INCREMENT'))), sql_in('auteurs.statut', $in), 
			array('NOT', 
