...
function BOUCLE_liste_arthtml_80b20190a5b466cae8a32dd7ba15b9a5(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
  ...
  'lien' => true,
	...
	$command['where'] = 
			...
			array('=', 'articles.id_article', sql_quote(($Pile[0]['id_article'] ?? null), '','bigint NOT NULL AUTO_INCREMENT')))), (!is_whereable(($Pile[0]['id_rubrique'] ?? null)) ? '' : ((is_array(($Pile[0]['id_rubrique'] ?? null))) ? sql_in('articles.id_rubrique', $in1) : 
			array('=', 'articles.id_rubrique', sql_quote(($Pile[0]['id_rubrique'] ?? null), '','bigint NOT NULL DEFAULT \'0\'')))), (!is_whereable(($Pile[0]['id_secteur'] ?? null)) ? '' : ((is_array(($Pile[0]['id_secteur'] ?? null))) ? sql_in('articles.id_secteur', $in2) : 
			array('=', 'articles.id_secteur', sql_quote(($Pile[0]['id_secteur'] ?? null), '','bigint NOT NULL DEFAULT \'0\'')))), (!is_whereable(($Pile[0]['id_trad'] ?? null)) ? '' : ((is_array(($Pile[0]['id_trad'] ?? null))) ? sql_in('articles.id_trad', $in3) : 
			array('=', 'articles.id_trad', sql_quote(($Pile[0]['id_trad'] ?? null), '','bigint NOT NULL DEFAULT \'0\'')))), 'JOIN-L1' => 
			...
			array('=', 'L1.id_auteur', sql_quote(($Pile[0]['id_auteur'] ?? null), '','bigint NOT NULL DEFAULT \'0\'')))), 'JOIN-L2' => 
			array('=', 'L2.objet', sql_quote('article')), (!is_whereable(($Pile[0]['id_mot'] ?? null)) ? '' : ((is_array(($Pile[0]['id_mot'] ?? null))) ? sql_in('L2.id_mot', $in5) : 
			array('=', 'L2.id_mot', sql_quote(($Pile[0]['id_mot'] ?? null), '','bigint NOT NULL DEFAULT \'0\'')))), 'JOIN-L3' => 
			...
			array('=', 'L3.id_document', sql_quote(($Pile[0]['id_document'] ?? null), '','bigint NOT NULL DEFAULT \'0\'')))), (($zzw = spip_sanitize_from_request(@$Pile[0]["where"],"where","vide")) ? $zzw : ''), (!is_whereable(($Pile[0]['statut'] ?? null)) ? '' : ((is_array(($Pile[0]['statut'] ?? null))) ? sql_in('articles.statut', $in7) : 
...
// Temps de compilation total: 11.477 ms
//
