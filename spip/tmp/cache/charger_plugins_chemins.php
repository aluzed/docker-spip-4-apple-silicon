...
if (_DIR_RESTREINT) _chemin([_DIR_PLUGIN_MEDIAS.'squelettes/',_DIR_PLUGIN_MEDIAS,_DIR_PLUGIN_COMPRESSEUR,_DIR_PLUGIN_BIGUP,_DIR_PLUGIN_URLS,_DIR_PLUGIN_TW,_DIR_PLUGIN_SVP,_DIR_PLUGIN_STATS,_DIR_PLUGIN_SITES,_DIR_PLUGIN_SAFEHTML,_DIR_PLUGIN_REVISIONS,_DIR_PLUGIN_PORTE_PLUME,_DIR_PLUGIN_PLAN,_DIR_PLUGIN_MOTS,_DIR_PLUGIN_MEDIABOX,_DIR_PLUGIN_FORUM,_DIR_PLUGIN_IMAGES,_DIR_PLUGIN_DUMP,_DIR_PLUGIN_COMPAGNON,_DIR_PLUGIN_ARCHIVISTE,_DIR_PLUGIN_AIDE]);
else _chemin([_DIR_PLUGIN_MEDIAS,_DIR_PLUGIN_COMPRESSEUR,_DIR_PLUGIN_BIGUP,_DIR_PLUGIN_URLS,_DIR_PLUGIN_TW,_DIR_PLUGIN_SVP,_DIR_PLUGIN_STATS,_DIR_PLUGIN_SITES,_DIR_PLUGIN_SAFEHTML,_DIR_PLUGIN_REVISIONS,_DIR_PLUGIN_PORTE_PLUME,_DIR_PLUGIN_PLAN,_DIR_PLUGIN_MOTS,_DIR_PLUGIN_MEDIABOX,_DIR_PLUGIN_FORUM,_DIR_PLUGIN_IMAGES,_DIR_PLUGIN_DUMP,_DIR_PLUGIN_COMPAGNON,_DIR_PLUGIN_ARCHIVISTE,_DIR_PLUGIN_AIDE]);
}
?>